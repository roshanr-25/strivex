...
export default function MobilNav() {
  ...
  return(
    ...
    <nav className='xl:hidden'>
      ...
      initial='hidden'
       animate={openMenu ? 
      'show': ''}    className='bg-white shadow-2xl w-full absolute top-0 right-0 max-w-xs h-screen z-20'>
      menu

      <div onClick={()=> setOpenMenu(false)} className='text-4xl absolute z-30 left-4 top-14 cursor-pointer'>
        <IoMdClose/>
      </div>
